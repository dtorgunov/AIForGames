...
.\footnote{Connor, please write the pathfinding bit here, also mention the improvements made and cite ourselves}

\subsection{Actions}

.\footnote{George, write something about the things you did}

\section{Testing and Tuning}
.\footnote{Write about the weird errors here? Because of reasons}
.\footnote{Mention the derp-tank}
